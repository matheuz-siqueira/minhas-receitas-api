...
public class RecipeValidator : AbstractValidator<RequestRecipeJson>
{
    public RecipeValidator()
    {
        ...
        RuleFor(recipe => recipe.Difficulty).IsInEnum().WithMessage("Unsupported difficulty.");
        ...
        {
            instructionRule.RuleFor(instruction => instruction.Step).GreaterThan(0).WithMessage("step cannot be negative or zero.");
